...
def main(path, task, n_trials, test_set_size):
    ...
    # Lo agregué yo, guardar el modelo
    model_path = './model_saved.pth'
    torch.save(gat_net.state_dict(), model_path)
    gat_net.state_dict()
    print("Model Saved")
...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--path', type=str, default='C:/Users/marti/OneDrive - UNIVERSIDAD NACIONAL AUTÓNOMA DE MÉXICO/Facultad de Química/servicio_social/PyCharm/photoswitches.csv',
